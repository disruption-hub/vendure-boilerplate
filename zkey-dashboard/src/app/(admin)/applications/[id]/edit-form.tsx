                            ...
                            {vendureEnabled && (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-4 md:col-span-2">
                                        <div className="space-y-1">
                                            <label className="text-xs font-semibold text-slate-500">Development Admin API URL</label>
                                            <input
                                                name="vendureAdminApiUrlDev"
                                                type="url"
                                                defaultValue={(application.integrations as any)?.vendure?.adminApiUrlDev || (application.integrations as any)?.vendure?.adminApiUrl || ''}
                                        ...
                                        <div className="space-y-1">
                                            <label className="text-xs font-semibold text-slate-500">Production Admin API URL</label>
                                            <input
                                                name="vendureAdminApiUrlProd"
                                                type="url"
                                                defaultValue={(application.integrations as any)?.vendure?.adminApiUrlProd || ''}
                                                className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm font-mono focus:ring-2 focus:ring-blue-500 outline-none"
