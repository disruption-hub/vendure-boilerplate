...
/**
 * Handle POST requests from Lyra after failed payment
...
<body>
  <p>Redirecting to payment failure page... <a href="${redirectUrl}">Click here if not redirected</a></p>
    ...
    console.error('[lyra-failure API] Error:', error)
...
export async function GET(request: NextRequest) {
  ...
  const redirectUrl = searchParams 
    ? `/payments/lyra/browser-failure?${searchParams}`
    : '/payments/lyra/browser-failure'
